...
import { useCollection, COL, getQuantityAvailable } from '@myshop/shared';
    ...
    <v-row class="mb-4">
      ...
      <v-col cols="12" sm="4">
        <v-card class="d-flex flex-column justify-center" style="min-height: 88px">
          <v-card-actions>
            <v-btn color="primary" to="/pos" prepend-icon="mdi-point-of-sale">Open POS</v-btn>
            <v-btn to="/admin/catalog/products/new" prepend-icon="mdi-plus">New product</v-btn>
          </v-card-actions>
        </v-card>
      </v-col>
    </v-row>
