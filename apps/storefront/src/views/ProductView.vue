...
import { db, COL, getEffectivePrice, formatMoney, getQuantityAvailable, applyPriceOperator, useAuth } from '@myshop/shared';
import { useCart } from '@myshop/shared/composables/useCart.js';
