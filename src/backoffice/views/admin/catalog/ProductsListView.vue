...
import { useProducts, getQuantityAvailable } from '../../../../composables/useProducts.js';
...
<template>
  <v-container class="py-6" fluid>
    <div class="d-flex align-center mb-4">
      ...
      <v-btn color="primary" prepend-icon="mdi-plus" to="/staff/admin/catalog/products/new">New product</v-btn>
    </div>
    ...
    <v-table>
      ...
      <tbody>
        <tr v-for="p in filtered" :key="p.id" style="cursor: pointer" @click="$router.push(`/staff/admin/catalog/products/${p.id}`)">
          <td class="py-2">
